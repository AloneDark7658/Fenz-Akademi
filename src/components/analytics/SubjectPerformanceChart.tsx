...
export function SubjectPerformanceChart({ data = [] }: { data?: any[] }) {
      ...
      <CardContent className="flex-1 min-h-[300px] relative mt-2">
        ...
        {isEmpty ? (
          <div className="absolute inset-0 flex flex-col items-center justify-center text-slate-500">
            ...
            <p className="text-sm font-medium">Henüz test çözmediniz</p>
            <p className="text-xs opacity-70">Konu analizi için quiz çözün.</p>
          </div>
        ) : (
